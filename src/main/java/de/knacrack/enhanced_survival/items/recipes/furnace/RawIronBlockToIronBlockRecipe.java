...
public class RawIronBlockToIronBlockRecipe implements Keyed, IRecipe {
    @Override
    public Recipe getRecipe() {
        return new FurnaceRecipe(getKey(), new ItemStack(Material.IRON_BLOCK), Material.RAW_IRON_BLOCK, 9, 200);
    }
